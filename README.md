The full documentation for this example is in the Factory Configurator Utility package, which you can download from the [portal](https://portal.mbedcloud.com/login).
