...
const uint8_t MBED_CLOUD_DEV_BOOTSTRAP_DEVICE_CERTIFICATE[] = {0};


const uint8_t MBED_CLOUD_DEV_BOOTSTRAP_SERVER_ROOT_CA_CERTIFICATE[] = {0};


const uint8_t MBED_CLOUD_DEV_BOOTSTRAP_DEVICE_PRIVATE_KEY[] = {0};


const char MBED_CLOUD_DEV_MANUFACTURER[] = "";

const char MBED_CLOUD_DEV_MODEL_NUMBER[] = "";

const char MBED_CLOUD_DEV_SERIAL_NUMBER[] = "";

const char MBED_CLOUD_DEV_DEVICE_TYPE[] = "";

const char MBED_CLOUD_DEV_HARDWARE_VERSION[] = "";
